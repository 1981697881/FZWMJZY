	...
	<view>
		...
		<view class="box getheight">
			...
			<view class="cu-bar bg-white solid-bottom" style="height: 60upx;">
				...
				<view class="action">
					<view style="width: 120px;">出货人:</view>
			...
			<view class="cu-bar bg-white solid-bottom" style="height: 60upx;">
				<view class="action">
					<view class="title">客户:{{ form.FCustName !="undefined" ? form.FCustName:''}}</view>
										...
										setTimeout(function() {
											uni.navigateBack({
												url: '../sales/salesActive?startDate=' + this
													.startDate + '&endDate=' + this.endDate
											});
										}, 1000);
									}
								}
